...
#include "soapH.h"
    ...
    class SOAP_CMAC Service : public soap {
      public:
        ...
        //
        /// Web service operation 'HacerAlgo' implementation, should return SOAP_OK or error code
        virtual int HacerAlgo(char *parametro, int &resultado) SOAP_PURE_VIRTUAL;
    };
#endif
