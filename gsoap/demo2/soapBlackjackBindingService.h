...
#ifndef soapBlackjackBindingService_H
#define soapBlackjackBindingService_H
#include "soapH.h"

    class SOAP_CMAC BlackjackBindingService {
      public:
        ...
        BlackjackBindingService();
        /// Copy constructor
        BlackjackBindingService(const BlackjackBindingService&);
        /// Construct service given a shared managing context
        BlackjackBindingService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        BlackjackBindingService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        BlackjackBindingService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~BlackjackBindingService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void BlackjackBindingService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual BlackjackBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        BlackjackBindingService& operator=(const BlackjackBindingService&);
        ...
        //
        /// Web service operation 'PedirCarta' implementation, should return SOAP_OK or error code
        virtual int PedirCarta(_ns1__PedirCarta *ns1__PedirCarta, _ns1__PedirCartaResponse &ns1__PedirCartaResponse) SOAP_PURE_VIRTUAL;
    };
#endif
