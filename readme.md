...
Este repositorio contiene una colección de pruebas de concepto y proyectos de demostración ("demos") para aprender y experimentar con varias bibliotecas populares de C++ en un entorno moderno (C++17).
